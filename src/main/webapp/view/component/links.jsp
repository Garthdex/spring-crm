...
<link href="<c:url value="/resources/bootstrap-3.3.7-dist/css/bootstrap-theme.css"/>" rel="stylesheet" type="text/css">
...
<link href="<c:url value="/resources/css/component/order.css"/>" rel="stylesheet" type="text/css">
